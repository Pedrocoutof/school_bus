...
const url = route('api.students.index');
                ...
                <div class="flex justify-between bg-white overflow-hidden shadow sm:rounded-lg">
                    <div class="flex items-center text-gray-600">
                        ...
                        <div class="flex items-center">
                            ...
                            <div  v-if="currentComponent === 'create'" class="p-6 text-gray-700">Adicionando estudante</div>
                            <div  v-if="currentComponent === 'details'" class="p-6 text-gray-700">Detalhes do estudante</div>
                        </div>
                    </div>
                    ...
                    <div v-if="currentComponent === 'details'" class="flex items-center pr-6 gap-x-4">
                        <DestroyButton :switch-component="switchComponent" :url-destroy="route('api.students.destroy', { route: selectedId })"></DestroyButton>
                    </div>
                </div>
            </div>
